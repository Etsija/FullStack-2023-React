    ...
    if (response.ok) {
        switch (act) {
            ...
            case "login":
                ...
                dispatch(loginSuccess(data.token)); // Set token
                dispatch(getList(data.token, "")); // Get shopping list
                return;
            case "logout":
        ...
        switch (act) {
            case "register":
                ...
                dispatch(registerFailed("Register failed with " + errorMessage));
                return;
            case "login":
                dispatch(loginFailed("Login failed with " + errorMessage));
                return;
            case "logout":
